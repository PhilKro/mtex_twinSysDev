...
for i = 1:length(tS)
    ...
    if tS.CS.lattice == 6
        %easier like this?
        rot = orientation.byAxisAngle(Miller(0,0,0,1,tS.CS),60*degree, tS.CS,tS.CS);
        k1 = tS.k1;
        eta1 = tS.eta1;
        k2 = tS.k2;
        eta2 = tS.eta2;
        ...
        for i = 2:6
            ...
            k2(i) = rot * k2(i-1);
            eta2(i) = rot * eta2(i-1);
            rotAxis(i) = rot * rotAxis(i-1);
        end
        % antipodal
        if ~check_option(varargin,'antipodal')
            -orientation.byAxisAngle(Miller(0,0,0,1,tS.CS),180*degree, tS.CS,tS.CS)
        end
        %Checks
